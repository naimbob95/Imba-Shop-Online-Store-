                ...
                <div class="modal-body col-lg-6">
                    <form action="AdminUpdateProductController" method="post" >
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" placeholder=" "  value="${product.getPname()}" name="pname"  required="">
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                            ...
                            <input type="number" class="form-control" placeholder=" "  value="${product.getPrice()}" name="price" required="">
                        </div>
                        <div class="right-w3l">
