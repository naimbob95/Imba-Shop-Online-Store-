    ...
    <body class="animsition">
        ...
        <div class="page-wrapper">
            ...
            <div class="page-content--bgf7">
                                ...
                                <div class="table-responsive table-responsive-data2">
                                    <table class="table table-data2">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                <td><%= u.getName()%></td>
                                                <td> <span class="block-email"><%= u.getEmail()%></span></td>
                                                <td><%= u.getType()%></td>
                                                <td><%= u.getRegisteredDate()%></td>
                                                <td>
                                                    <div class="table-data-feature">

                                                        <button class="item" data-toggle="tooltip" data-placement="top" title="Delete"><a href="AdminDeleteUserController?action=delete&id=<%= u.getId()%>">
                                                                <div class="del1">
                ...
                <div class="modal fade" id="EditItems" tabindex="-1" role="dialog" aria-hidden="true">
                            ...
                            <div class="modal-body">
                                <form action="#" method="post">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="date" class="form-control" placeholder=" " name="Password" required="">
                                    </div>
                                    <div class="form-group">
