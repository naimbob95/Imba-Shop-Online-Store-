                                                        ...
                                                        <fieldset>
                                                            ...
                                                            <div class="form-group row">
                                                                <div class="col-sm-3" style="padding-left: 20px">
                                                                    <input class="form-control-sm" type="number" name="quantity" placeholder="Qty" style="width: 72px" required/>
                                                                </div>&nbsp;&nbsp;
                                                                <div class="col-sm-3" style="padding-left: 20px">
                                                                    <input class="form-control-sm" type="submit" name="submit" value="Add to cart" class="btn btn-success" />
                                                                </div>
                                                            </div>
                                                        </fieldset>
                                                    </form>
